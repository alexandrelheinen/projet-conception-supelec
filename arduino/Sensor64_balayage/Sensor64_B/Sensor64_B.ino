...
int num1 = 4;
int num2 = 1;
int pas1 = (posFi1 - posIn1)/num1;
int pas2 = (posFi2 - posIn2)/num2;
int pinServo1 = 9;
int pinServo2 = 11;
...
void setup() {
  ...
  pas1 = (posFi1 - posIn1)/num1;
  pas2 = (posFi2 - posIn2)/num2;
...
void loop(){
  servo1.write(posIn1 + compt1*pas1);
  servo2.write(posIn2 + compt2*pas2);   
  
  delay(250); // a little delay
  ...
  // **************** IMAGE ACQUISITION **************************************
   ...
   // DATA TRANSMITION
   Serial.println(-(300+10*compt2+compt1)); // the initial value must be less then -300 to identify the image start
